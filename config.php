 ...
 */
$cfg->dataroot = 'E:\working-vitechsoft\eSelma\trunk\mahara_data_upload';
 ...
 */
$cfg->passwordsaltalt1 = 'ER?spuCasE5aKupR';

$cfg->pathtounzip = 'C:/Zip_Unzip/usr/local/wbin/unzip.exe';
$cfg->pathtozip   = 'C:/Zip_Unzip/usr/local/wbin/zip.exe';
...
//$cfg->smtpuser = 'vohung96@gmail.com';
//$cfg->smtppass = 'voxhungf1703';
//$cfg->smtpsecure = 'ssl';
//$cfg->smtpport = '465';

$cfg->pathtowkhtmltopdf = 'C:\Program Files\wkhtmltopdf\bin\wkhtmltopdf.exe';
$cfg->pathtoxvfbrun = '/usr/bin/xvfb-run';
