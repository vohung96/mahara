            ...
            <form name="editevent" method="get" action="" id="editevent"> 						
                ...
                {if $specify_parent == 1}
                    <p>
                        ...
                        <span class="requiredmarker">*    HOLIDAY*</span><br/>
                        {foreach from=$plans.data item=plan}
                            {if $plan->title == 'HOLIDAY'}
                                <input type="hidden" class="required" id="edittask_parent" name="parent_id" value="{$plan->id}"/>
                            {/if}                            
                        {/foreach}
                    </p>
                {/if}
                <p>
                    ...
                    <input type="hidden" class="note" id="note" name="note" value="listholiday"/>
                </p>
                <hr>
                <p>
