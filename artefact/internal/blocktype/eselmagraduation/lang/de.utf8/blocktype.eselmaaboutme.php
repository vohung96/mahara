...
$string['title'] = 'Über Mich';
$string['showlastname'] = 'Name';
$string['showfirstname'] = 'Vorname';
$string['studentid'] = 'Benutzer-ID';
$string['showpreferredname'] = 'Anzeigename';
$string['showintroduction'] = 'Was ich noch zu sagen habe';
$string['editaboutme'] = 'Edit Über Mich';
