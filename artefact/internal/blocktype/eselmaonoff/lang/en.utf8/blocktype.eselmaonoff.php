...
$string['title'] = 'Online/offline Contact';
$string['showemail']='Email';
$string['showmobilenumber']='Mobile number';
$string['showaddress']='Address';
$string['editcontact']='Edit Contact';
$string['editsocial']='Edit Social Media';
