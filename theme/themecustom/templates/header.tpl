...
<div id="container">
    ...
    <div id="top-wrapper">
        <div id="header">
            <div id="site-logo">
                <div id="site-logo-1" href="{$WWWROOT}">
                    <a href="{$WWWROOT}">
                        <img src="{$sitelogo}" alt="{$sitename}">
                    </a>
                </div>
                <div id="site-logo-2" href="{$WWWROOT}">
                    <a href="{$WWWROOT}">
                        <img src="{theme_url filename='images/1.png'}" alt="{$sitename}">
                    </a>
                </div>
                <div id="site-logo-3" href="{$WWWROOT}">
                    <a href="{$WWWROOT}">
                        <img src="{theme_url filename='images/2.png'}">
                    </a>
                </div>
