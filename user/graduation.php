...
define('SECTION_PAGE', 'graduation');
...
if (!$USER->is_logged_in()) {
    throw new AccessDeniedException(get_string('youcannotviewthisusersgraduation', 'error'));
}

$view = $USER->get_graduation_view();
$viewcontent = $view->build_rows();

$javascript = array('paginator', 'lib/pieforms/static/core/pieforms.js', 'expandable', 'groupbox');
...
$smarty->assign('viewtype', 'graduation');
$smarty->assign('viewid', $view->get('id'));
$smarty->display('user/graduation.tpl');
